...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor = db.rawQuery("SELECT num, title, recommend FROM catchTBL17", null);
        ...
        while (cursor.moveToNext()) {
            ...
            count++;    //글 하나를 표시할 때 마다 글 번호 하나씩 증가
        }
        ...
        //리스트뷰 클릭 이벤트 - 제목부분을 클릭하면 해당 글로 화면 이동
